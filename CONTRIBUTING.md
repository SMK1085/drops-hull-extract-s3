...
You can [open a ticket](https://github.com/SMK1085/drops-hull-extract-s3/issues/new) with your questions or issues any time. Feature requests are also welcome, please describe the feature, why you need it, and how it should work.
...
- You are using the [latest version](https://github.com/SMK1085/drops-hull-extract-s3/releases).
- You have read the [documentation](https://github.com/SMK1085/drops-hull-extract-s3/blob/master/README.md) first, and
